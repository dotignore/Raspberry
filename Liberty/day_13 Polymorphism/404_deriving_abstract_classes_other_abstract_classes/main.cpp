...
class Animal{   // Общий базовый класс для классов Mammal и Fish
public:
    Animal(int);
...
class Mammal : public Animal {              // Mammal - Animal
public:
...
class Fish : public Animal {                // Fish - Animal
public:
...
class Horse : public Mammal {               // Horse - Mammal
public:
...
class Dog : public Mammal{                  // Dog - Mammal
public:
...
int main() {
    Animal * pAnimal=0;         // почему не иницируется класс Aninal?
    int choice;
    bool fQuit = false;
...
///////// 2
 ...
 pAnimal->Speak();      Whinny!...
 pAnimal->Eat();		Horse feeding...
 pAnimal->Reproduce();	-+Mammal reproduction depicted...
 pAnimal->Move();       Horse running...
 pAnimal->Sleep();      Horse snoring...
