// Листинг 13,6 Виртуальное наследование
#include<iostream>
using namespace std;
...
Horse(aColor, height, age), Bird(aColor, migrates, age), Animal(age*2), itsNumberBelievers(NumBelieve){
...
int main(){
    ...
    int age = pPeg->GetAge();
    cout << "Ntis pegasus is " << age << " years old.\n";
    delete pPeg;
